...
export const testimonials: Testimonial[] = [
  {
    ...
    text: "Excelente serviço! A equipe da Fachadas MC realizou um trabalho impecável na limpeza da nossa fachada. Profissionais muito competentes e atenciosos.",
    rating: 5,
  },
  {
    id: 2,
    ...
    text: "Contratamos a Fachadas MC para a manutenção periódica do nosso shopping e estamos muito satisfeitos com o resultado. Pontualidade e qualidade no atendimento.",
    rating: 5,
  },
  {
    id: 3,
    ...
    text: "Serviço de primeira qualidade! A limpeza da fachada do nosso condomínio ficou perfeita. Recomendo fortemente!",
    rating: 5,
  },
];
